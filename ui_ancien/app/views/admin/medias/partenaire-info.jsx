...
export default React.createClass({
    ...
    create() {
        if (this.validate()) {
            ...
            if (this.state._id) {
                adminServices.editMedia({ ...data, id: this.state._id}).then(this.props.onPopinClose);
            } else {
                adminServices.createMedia(data).then(this.props.onPopinClose);
            }
        }
    },
    /** @inheritDoc */
