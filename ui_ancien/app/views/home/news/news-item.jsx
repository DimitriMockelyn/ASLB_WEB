        ...
        <div data-focus='panel-into-panel'>
            <Panel title={this.props.data.titre} data-important={this.props.data.important}>
                ...
                <div data-focus='news-info'>
                    <div>{i18n.t('admin.newsCreatedBy') + ' ' + (this.props.data.createur ? this.props.data.createur.nom + ' ' + this.props.data.createur.prenom : '') + ' ' + i18n.t('admin.newsCreatedAt') + ' ' + moment(this.props.data.date, moment.ISO_8601).format('DD/MM/YYYY - HH:mm')}</div>
                </div>
            </Panel>
        </div>
        );
