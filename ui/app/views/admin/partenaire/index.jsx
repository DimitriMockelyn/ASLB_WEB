...
export default React.createClass({
    ...
    loadAllPartenaires() {
        homeServices.loadPartenaires().then(res => {this.setState({ptn: res})});
    },
    openPopin(ptn) {
    ...
    renderActionsEdit() {
        if (!this.props.hideButtons) {
            return <div>
                <Button type='button' label='admin.addPartenaire' handleOnClick={() => {this.openPopin()}}/>
    ...
    renderContent() {
        return (
        <Panel  title='Partenaires' actions={this.renderActionsEdit}>
